...
alias ls="eza --icons=always --group-directories-first"                        # Basic view with icons and folders grouped first
alias lsa="eza -a --icons=always --group-directories-first"                    # Alternate normal grid view with hidden files and folders first
alias ll="eza -l --icons=always --git --group-directories-first"               # Long list view with Git status and folders first
alias la="eza -la --icons=always --git --group-directories-first"              # Long list view with hidden files and folders first
alias lx="eza -lbhHigUmuSa --icons=always --git --group-directories-first"     # Extended metadata view with folders first
alias lt="eza --tree --icons=always --group-directories-first"                 # View directory structure tree with folders first
alias ltd="eza --tree --level=2 --icons=always --group-directories-first"      # View 2-level deep tree with folders first
